...
**Student Name  :** G.Abinaya  
**Student ID    :** 2310040009 
...
|------------|-------------|-------------|------------------------------|
| 1 — Baseline | mutation_rate = 0.05 | 320 | The genetic algorithm quickly converges towards a high value solution |
